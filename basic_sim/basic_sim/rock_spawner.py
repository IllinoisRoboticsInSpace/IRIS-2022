...
def main():
    ...
    sdf_file_path = os.path.join(
        get_package_share_directory("basic_sim"), "models",
        "rock_small", "model.sdf")
    ...
    request.initial_pose.position.x = uniform(0,5)
    request.initial_pose.position.y = uniform(0,5)
